...
export default function TouristVisaRequirements() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1450px] px-4 py-14 sm:px-6 md:px-8 md:py-16 lg:px-16 lg:py-20">
        ...
        <div className="text-center">
          ...
          >
            While requirements vary by destination, these are
            the common documents needed for most tourist and
            travel visa applications worldwide.
          </p>
