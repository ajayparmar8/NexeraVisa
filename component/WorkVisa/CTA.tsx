...
const contactItems = [
  { icon: Phone,  value: "Free initial consultation", isMultiLine: false },
  { icon: Mail,  value: "Expert document review", isMultiLine: false },
  {
    icon: MapPin,
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col justify-center px-6 py-10 text-white sm:px-8 md:px-14">
            ...
            <h2
              ...
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
              <AnimatedLine delay={0.35}>Ready to Advance</AnimatedLine>
              <AnimatedLine delay={0.5}>
                Your <span className="text-[#60A5FA]">Career Abroad?</span>
              </AnimatedLine>
            </h2>
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
             Start your work visa application today and take the first step towards international employment opportunities. Our expert team will guide you through every step of the process.
            </motion.p>

            {/* Contact items */}
            <div className="mt-10 space-y-6">
              {contactItems.map(({ icon: Icon, value, isMultiLine }, i) => (
                <motion.div
