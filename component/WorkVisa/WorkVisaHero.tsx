...
export default function WorkVisaHero() {
  return (
    <section
    ...
    >
      ...
      <img
        src="work.png"
        alt="Work Visa"
        className="absolute inset-0 h-[650px] w-full object-cover object-center"
      />
...
<div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white px-6 pt-16">
        ...
        >
          ...
          <span className="text-gray-200">Work Visa</span>
        </motion.div>
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          Professional assistance for obtaining work visas and employment
