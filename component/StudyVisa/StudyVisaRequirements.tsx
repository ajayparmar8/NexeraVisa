...
export default function StudyVisaRequirements() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1450px] px-4 py-14 sm:px-6 md:px-8 md:py-16 lg:px-16 lg:py-20">
        ...
        <div className="text-center">
          ...
          {/* DESCRIPTION */}
          <p
            className="mx-auto mt-4 max-w-[760px] px-2 text-[13px] leading-7 text-[#374151] sm:text-[14px] md:text-[15px]"
            style={{
              fontFamily: "'Inter', sans-serif",
            }}
          >
            While specific requirements vary by country and
            institution, here are the common documents needed
            for successful international study visa applications.
          </p>
            ...
            {[...leftRequirements, ...rightRequirements].map(
              (item, index) => (
                ...
                >
                  ...
                  <p
                    className="text-[19px] leading-[1.25] text-[#0A0F1C]"
                    style={{
                      fontFamily: "'Cormorant Garamond', serif",
                    }}
                  >
            ...
            <div className="space-y-6 text-right">
              ...
              {leftRequirements.map((item, index) => (
                ...
                >
                  ...
                  <p
                    className="whitespace-nowrap text-[22px] leading-none text-[#0A0F1C] lg:text-[25px]"
                    style={{
                      fontFamily: "'Cormorant Garamond', serif",
                    }}
                  >
